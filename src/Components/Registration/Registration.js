...
const Registration = () => {
    ...
    const handleRegister = (e) => {
        ...
        console.log(name, profileLink, email, password);
                    ...
                    <Container className='text-white mb-5'>
                        <Form onSubmit={handleRegister} className='login-container'>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicEmail2">
                                ...
                                <Form.Control name="profileLink" type="text" placeholder="Profile Img Link" />
                            </Form.Group>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicCheckbox5">
                                <Form.Check type="checkbox" label="Accept our" />
                            </Form.Group>
